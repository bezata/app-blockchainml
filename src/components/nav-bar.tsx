...
export function NavBar() {
  ...
  const ProfileMenu = ({ isMobile = false }) => (
    <div className={`${isMobile ? 'w-full' : 'w-56'} bg-white rounded-md shadow-lg ring-1 ring-black ring-opacity-5 divide-y divide-gray-100 focus:outline-none`}>
      <div className="px-4 py-3 flex items-center space-x-2">
        <div className="w-2 h-2 bg-green-400 rounded-full animate-pulse"></div>
        <span className="text-sm font-medium text-gray-700">base and swap</span>
      </div>
      <div className="py-1">
...
// ... (rest of the component code, including NavLink and icon components, remains unchanged)