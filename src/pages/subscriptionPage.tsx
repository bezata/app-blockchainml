    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-gray-100 p-8">
      ...
      >
        <div className="text-center mb-12">
          <h1 className="text-4xl font-light text-gray-800 mb-4">Choose Your Plan</h1>
          <p className="text-xl text-gray-600 mb-8">Select the perfect plan for your needs</p>
          <div className="flex items-center justify-center space-x-4">
            <span className={`text-sm ${isYearly ? 'text-gray-500' : 'text-gray-900 font-medium'}`}>Monthly</span>
            <Switch
              checked={isYearly}
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {plans.map((plan) => (
            <Card key={plan.name} className="bg-white shadow-sm hover:shadow-md transition-shadow duration-300">
              <CardHeader>
                <CardTitle className="text-2xl font-medium text-gray-800">{plan.name}</CardTitle>
